...
function encryptDataInBase64(data, raw_key)//var raw_key = "1234567890098765";
{
  ...
  var key = CryptoJS.enc.Base64.parse(raw_keybase64);
  var encrypted = CryptoJS.AES.encrypt(data, key, {
    mode: CryptoJS.mode.ECB,
    padding: CryptoJS.pad.Pkcs7
  });
  var encryptDataInBase64 = encrypted.ciphertext.toString(CryptoJS.enc.Base64);
  return encryptDataInBase64;
}

// mId, maId.
function hashDataInBase64(data) {
  var hash = CryptoJS.SHA256(data);
  var hashDataInBase64 = hash.toString(CryptoJS.enc.Base64);
